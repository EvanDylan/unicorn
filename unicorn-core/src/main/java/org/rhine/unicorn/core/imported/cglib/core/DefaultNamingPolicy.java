...
public class DefaultNamingPolicy implements NamingPolicy {
     ...
     */
    private final static boolean STRESS_HASH_CODE = Boolean.getBoolean("org.rhine.unicorn.core.imported.cglib.test.stressHashCodes");
    
    public String getClassName(String prefix, String source, Object key, Predicate names) {
        if (prefix == null) {
            prefix = "org.rhine.unicorn.core.imported.cglib.empty.Object";
