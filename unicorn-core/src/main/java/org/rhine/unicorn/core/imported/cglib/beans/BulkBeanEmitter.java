...
class BulkBeanEmitter extends ClassEmitter {
    ...
    private static final Type BULK_BEAN =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.beans.BulkBean");
    private static final Type BULK_BEAN_EXCEPTION =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.beans.BulkBeanException");
