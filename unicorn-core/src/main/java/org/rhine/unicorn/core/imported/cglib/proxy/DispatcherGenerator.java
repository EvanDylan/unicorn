...
class DispatcherGenerator implements CallbackGenerator {
    ...
    private static final Type DISPATCHER =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.proxy.Dispatcher");
    private static final Type PROXY_REF_DISPATCHER =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.proxy.ProxyRefDispatcher");
