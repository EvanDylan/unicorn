...
implements CallbackGenerator
{
    ...
    private static final Type INVOCATION_HANDLER =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.proxy.InvocationHandler");
    private static final Type UNDECLARED_THROWABLE_EXCEPTION =
      TypeUtils.parseType("org.rhine.unicorn.core.imported.cglib.proxy.UndeclaredThrowableException");
